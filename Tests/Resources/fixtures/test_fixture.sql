...
CREATE TABLE `ca_categories` (
  ...
  `default_locale` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `lft` int NOT NULL,
  `rgt` int NOT NULL,
  `depth` int NOT NULL,
...
CREATE TABLE `ca_category_meta` (
  ...
  `locale` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ca_category_translations` (
  ...
  `locale` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `re_references` (
  ...
  `resourceKey` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `resourceId` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `referenceResourceKey` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `referenceResourceId` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `referenceLocale` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `referenceRouterAttributes` json NOT NULL,
  `referenceTitle` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `referenceProperty` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `referenceContext` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created` datetime NOT NULL,
  `changed` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `ro_routes` VALUES (1,NULL,'/blog/example-article','de','Sulu\\Bundle\\ArticleBundle\\Document\\ArticleDocument','52634b61-09b3-4224-a428-4a885dceb98f',0,'2025-12-09 15:12:10','2025-12-09 15:12:10',1,1),(2,NULL,'/blog/timestamp-fallback-article','de','Sulu\\Bundle\\ArticleBundle\\Document\\ArticleDocument','b5224d7b-b780-419b-9faf-7ff991bf6b3f',0,'2026-03-05 14:51:33','2026-03-05 14:51:33',1,1);
...
INSERT INTO `se_users` VALUES (1,'admin','$2y$13$Nl41Z4rKp.Y3X5/kWZP6.eWJ9AyvT18pk3NSZ8w6VBfk7ZPmZrcli','en','gHpHuTaATubZoglSLPkz/NpsXB+0fGdrHZo6jVV7W1w=',0,1,'2026-03-05 14:49:56',NULL,NULL,NULL,NULL,NULL,'9cef63ce0eca59e51fb6b00e901be267','admin@example.com','2025-12-09 09:37:46','2026-03-05 14:49:56',1,NULL,1);
...
-- Dump completed on 2026-03-05 14:53:51
